...
# Load images      
shell_image = pygame.image.load("shell_empty_closed.png")
shell_image = pygame.transform.scale(shell_image, (200, 200))
ball_image = pygame.image.load("open_shell_full.png")
ball_image = pygame.transform.scale(ball_image, (250, 200))
bg_image = pygame.image.load("background.jpg")

# Load character sprites
player_sprite = pygame.image.load("3.png")
player_victory_sprite = pygame.image.load("3_victory.png")
...
def draw_game(show_ball=False, message=None, victory=False):
    ...
    draw_text(f"Credit: £{credit}", font, (255, 255, 255), screen, 1100, 420)
